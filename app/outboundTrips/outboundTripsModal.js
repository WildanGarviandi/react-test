...
import {DropdownTypeAhead, Input, Pagination, ButtonWithLoading, EmptySpace, InputWithDefault} from '../views/base';
...
import {FullAddress, TripDropOff, AssignedTo, Remarks, Weight, DstHub, DstDistrict, ProcessTrip, HubSetter} from './outboundTripsHelper';
  ...
  render() {
    ...
    return (
      <ModalDialog className={styles.modalDialog}>
        ...
        <div className={styles.modalInfo + " nb"}>
          <div>
            ...
            <div className="row">
              ...
              { !this.state.isAssign && !this.state.isLastMile &&
        ...
        { !this.state.isAssign && !this.state.isHubAssign &&
          <div className="nb">
            <Tabs selected={0}>
...
function ModalStateToProps (state) {
  ...
  const {trip, nearbyfleets, nearbyDrivers} = outboundTripsService;
